(function() {
  ...
  function deal() {
    ...
    context.drawImage(imageObj, 565, 20, 80, 130); //dealer card

  };

  imageObj.src = 'deck/diamonds/10D.png';
  ...
  function movecards(){
  		...
  		// and the mage is re drawn with new coordinates
  ...
  interval_id=setInterval(movecards, 10);
	...
	function table(){
		...
		var imageObj = new Image();
		imageObj.onload = function() {
			context.drawImage(imageObj,575,0,80,129);
			};
